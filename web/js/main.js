...
;(function(window) {
	...
	var bodyEl = document.body, 
		...
		scrollcontainer_z_s = document.querySelector('.container_z_s'),
	...
	function openItem(item) {
		...
		// disallow scroll
		scrollcontainer_z_s.addEventListener('scroll', noscroll);
		// apply transforms
	...
	function closeContent() {
		...
		onEndTransition(contentItem, function(ev) {
			...
			lockScroll = false;
			scrollcontainer_z_s.removeEventListener('scroll', noscroll);
	...
	// disallow scrolling (on the scrollcontainer_z_s)
	function noscroll() {
		if(!lockScroll) {
			lockScroll = true;
			xscroll = scrollcontainer_z_s.scrollLeft;
			yscroll = scrollcontainer_z_s.scrollTop;
		}
		scrollcontainer_z_s.scrollTop = yscroll;
		scrollcontainer_z_s.scrollLeft = xscroll;
	}
